...
const CHANNEL_TYPES = [
  {
    ...
    color: "#00FF41", border: "rgba(0,255,65,0.3)",
    badge: "Bidirectional", badgeColor: "#00FF41",
  ...
  },
  {
    ...
    color: "#9A9A9A", border: "rgba(154,154,154,0.3)",
              ...
              return (
                <motion.button key={t.id}
                  ...
                  style={{
                    ...
                    border: `1px solid ${active ? t.border : "#1F1F1F"}`,
                    cursor: "pointer",
                    borderLeft: active ? `2px solid ${t.color}` : "1px solid #1F1F1F",
                  }}
                >
                  <div className="flex items-center gap-2">
                    <span style={{ color: active ? t.color : "#4A4A4A" }}><Icon size={13} /></span>
                    <span className="text-xs font-medium"
                      style={{ fontFamily: "'Fira Code', monospace", color: active ? "#E0E0E0" : "#4A4A4A" }}>
                      {t.label}
                    </span>
                  </div>
          ...
          <div className="col-span-2 space-y-4">
            ...
            <div className="p-4" style={{ background: "rgba(0,255,65,0.02)", border: `1px solid ${typeInfo.border}` }}>
              <div className="flex items-start gap-3">
                <Info size={13} style={{ color: "#00FF41", marginTop: 1, flexShrink: 0 }} />
                <div>
                  <p className="text-xs font-medium" style={{ fontFamily: "'Fira Code', monospace", color: "#E0E0E0" }}>
                    {typeInfo.label}
                  </p>
                  <p className="text-xs mt-0.5" style={{ fontFamily: "'Fira Code', monospace", color: "#4A4A4A" }}>
                    {typeInfo.desc}
                  </p>
                  <p className="text-xs mt-1.5" style={{ fontFamily: "'Fira Code', monospace", color: "#00FF41" }}>
            ...
            <div className="hud-panel p-4">
              ...
              {channels.length === 0 ? (
                <div className="text-center py-8 text-xs" style={{ fontFamily: "'Fira Code', monospace", color: "#2A2A2A" }}>
                    ...
                    {channels.map(ch => {
                      ...
                      return (
                        <motion.div key={ch.id}
                          ...
                          style={{ background: "rgba(0,255,65,0.02)", border: "1px solid #1F1F1F" }}>
                          <div className="flex items-center gap-3">
                            <span style={{ color: "#00FF41" }}><Icon size={13} /></span>
                            <div>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <button onClick={() => copyCommand(ch)}
                              ...
                              onMouseEnter={e => { (e.currentTarget as HTMLElement).style.color = "#00FF41"; }}
                              onMouseLeave={e => { (e.currentTarget as HTMLElement).style.color = "#4A4A4A"; }}>
                              {copied === ch.id ? <CheckCircle size={12} style={{ color: "#00FF41" }} /> : <Copy size={12} />}
                            </button>
            ...
            {/* Commands reference */}
            <div className="hud-panel p-4">
              <p className="text-xs tracking-widest mb-3" style={{ fontFamily: "'Fira Code', monospace", color: "#00FF41" }}>
                // AGENT_COMMANDS
              </p>
              <div className="space-y-2">
                {[
                  ...
                  <div key={cmd} className="flex items-start gap-3">
                    ...
                    <span className="text-xs pt-1" style={{ fontFamily: "'Fira Code', monospace", color: "#4A4A4A" }}>
                      {desc}
                    </span>
                  </div>
                ))}
